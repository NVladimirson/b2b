        ...
        <div class="right-actions-block">
            ...
            <li class="dropdown navbar-user">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a href="{{route('auth.login_to_site')}}" class="dropdown-item"><img src="{{asset('assets/img/construction.ico')}}" alt="Dinmark" style="width: 16px; height: 16px; margin: 0; float: none"> @lang('user.dinmark_link')</a>
                    <div class="dropdown-divider"></div>
                    ...
                    <div class="top-actions-block">
                            ...
                            <div class="right-action-block">
                                <a class="dropdown">
                                    ...
                                    <div class="dropdown-menu media-list dropdown-menu-right">
                                        <div class="dropdown-header">@lang('notification.tab_name')</div>
                                ...
                                <a class="dropdown navbar-language">
                                    <a href="#" class="dropdown-toggle pr-2 pl-2 pr-sm-4 pl-sm-4" data-toggle="dropdown">
                                        <span class="flag-icon flag-icon-{{ LaravelLocalization::getCurrentLocale() }}" title="{{ LaravelLocalization::getCurrentLocale() }}"></span>
                                        <span class="name d-none d-sm-inline"></span> <b class="caret"></b>
                                    </a>
                                    <div class="dropdown-menu">
                                ...
                                <a class="dropdown navbar-user">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <img src="{{asset('assets/img/construction.ico')}}" alt="Dinmark" style="width: 16px; height: 16px; margin: 0; float: none"> @lang('user.dinmark_link')</a>
                                        <div class="dropdown-divider"></div>
                                        <form method="POST" action="{{ route('logout') }}">
                                            @csrf
                                            <button type="submit" class="dropdown-item" class="btn btn-link">@lang('user.logout')</button>
